...
def read_data(dataset_path, normalization_method, past_history_factor, forecast_horizon):
    ...
    tmp_data_path = os.path.normpath(dataset_path) + "/{}/{}/{}/".format(
        normalization_method, past_history_factor, forecast_horizon
    )
...
def _run_experiment(
    ...
    x_train, y_train, x_test, y_test, y_test_denorm, norm_params = read_data(
        dataset_path, normalization_method, past_history_factor, forecast_horizon
    )
    ...
    print('END OF EXPERIMENT -> ./results/{}/{}/{}/{}/{}/{}/{}/{}/{}'.format(dataset, normalization_method,
                                                                           past_history_factor, forecast_horizon,epochs, learning_rate,
...
def main(args):
    ...
    for dataset_index, dataset_path in enumerate(datasets):
        ...
        for epochs, normalization_method, past_history_factor, forecast_horizon in itertools.product(
                parameters["epochs"],
